CREATE OR REPLACE PROCEDURE P_his_deal_dtl_more_90(Count in number) IS
...
BEGIN
   ...
   select Count - count(*) into v_count from LPT2_XM128_DEAL.his_deal_dtl_more_90; 
   ...
   for i in 1 .. v_count loop
      ...
      values (
        ...
        '1234567890000000031', '20150429', '28-2月 -15 06.55.39.483000 下午', 1000.99,
        0.00, 0.00000, 0.00000, '04',
        '01', '02', null, null,
        null, '1006', '04', null,
        null, '0', '支付状态:04,异常信息:null', null,
        '01', null, 'web', null,
        null, '20150428', null, '28-2月 -15 06.55.38.322000 下午',
        null);
