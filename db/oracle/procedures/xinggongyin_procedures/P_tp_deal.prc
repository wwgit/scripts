CREATE OR REPLACE PROCEDURE P_tp_deal(Count in number) IS
...
BEGIN
   ...
   select Count - count(*) into v_count from LPT2_XM128_DEAL.tp_deal; 
   ...
   for i in 1 .. v_count loop
        ...
        values (
          ...
          null, null, null, null,
          null, 'web', null, null,
          '20150428', null, '00', '28-4月 -15 06.55.38.322000 下午', 
          null
          );
